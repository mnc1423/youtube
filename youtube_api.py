...
class Youtube_API:
    def __init__(self):
        ...
        parser.add_argument("--q", help="Search term", default="bitcoin keygen")
    ...
    def youtube_search(self):
        search_response = (
            self.youtube.search()
            .list(q=self.args.q, part="id,snippet", maxResults=self.args.max_results)
            .execute()
        )
        videos = []
